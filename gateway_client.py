...
ANDROID_DEVICE_TYPE = "OnePlus7Pro" # Tipul dispozitivului creat


# Funcție de extragere a clientului gateway-ului
...
# Funcție de trimitre a detaliilor despre gateway (în acest caz, laptopul)
...
# Funcție de trimitire a datelor la un anumit interval
...
# Funcție de trimitere a evenimentelor către client
